    ...
    <div className="min-h-screen" style={{ background: '#FFFFFF' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-3xl font-black uppercase tracking-tight" style={{ color: '#FFFFFF' }}>
                  highphaus
                </div>
                <div className="text-xs font-bold uppercase tracking-widest" style={{ color: '#0052FF' }}>
                  COMMUNITY FAUCET
                </div>
              </div>
            </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5" style={{
          background: 'repeating-linear-gradient(45deg, #000000 0px, #000000 20px, transparent 20px, transparent 40px)',
        }} />
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          {/* ETH Price Display */}
          <div className="inline-block px-6 py-3 font-bold uppercase text-sm" style={{ 
            background: '#F5F5F5',
            color: '#0052FF'
          }}>
      ...
      <section className="relative overflow-hidden">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-0">
          ...
          >
            ...
            <div className="text-xs uppercase font-black tracking-widest mb-4" style={{ color: '#888888' }}>
              DISTRIBUTED
            </div>
          ...
          >
            <div className="absolute top-0 right-0 w-16 h-16 opacity-20" style={{
              background: '#FFFFFF',
              clipPath: 'polygon(0 0, 100% 0, 100% 100%)',
            }} />
            <div className="text-xs uppercase font-black tracking-widest mb-4" style={{ color: 'rgba(255,255,255,0.6)' }}>
              COMMUNITY
            </div>
            <div className="text-5xl lg:text-7xl font-black mb-2" style={{ color: '#FFFFFF' }}>
          ...
          >
            <div className="absolute top-0 right-0 text-9xl font-black opacity-5" style={{ color: '#FFFFFF' }}>
              Ξ
            </div>
            <div className="text-xs uppercase font-black tracking-widest mb-4 relative z-10" style={{ color: 'rgba(255,255,255,0.6)' }}>
              HAUS BALANCE
            </div>
            <div className="text-5xl lg:text-7xl font-black mb-2 relative z-10" style={{ color: '#FFFFFF' }}>
              {stats ? stats.contractBalance : '0'}
            </div>
            <div className="text-sm font-black uppercase relative z-10" style={{ color: '#000000' }}>
              ETH
            </div>
          </div>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          {isConnected && (
            <div>
              ...
              <div className="mb-8">
                <h3 className="text-2xl font-black uppercase mb-6 text-center" style={{ color: '#FFFFFF' }}>
                  ...
                  {['10', '50', '100'].map((amount, idx) => (
                    <button
                      ...
                      style={{ 
                        ...
                        clipPath: idx === 1 ? 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' : 'polygon(3% 0%, 100% 0%, 97% 100%, 0% 100%)',
                      }}
                    >
                      {depositAmount === amount && (
                        <div className="absolute bottom-0 left-0 w-full h-2" style={{ background: '#00D4FF' }} />
                      )}
                      <div>${amount}</div>
                ...
                {depositAmount && (
                  <div className="mt-4 text-center">
                    ...
                    <div className="text-sm opacity-60" style={{ color: '#FFFFFF' }}>
                      (Helps {Math.floor(parseFloat(depositAmount) / 0.10)} builders claim)
                    </div>
                  </div>
                )}
              </div>
              ...
              >
                <div className="absolute top-0 right-0 w-2 h-full" style={{ background: '#0052FF' }} />
              ...
              <button
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = 'linear-gradient(135deg, #0052FF 0%, #00D4FF 100%)';
                }}
              >
              ...
              <p className="text-center text-xs font-bold uppercase mt-4" style={{ color: '#888888' }}>
      ...
      >
        <div className="absolute inset-0 opacity-5" style={{
          background: 'repeating-linear-gradient(45deg, #0052FF 0px, #0052FF 2px, transparent 2px, transparent 40px)',
        }} />
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="text-sm font-bold uppercase tracking-widest mb-8" style={{ color: '#0052FF' }}>
